...
graph1 <- ggplot() +
  ggtitle("Metodo 1") +
  geom_line(data = naive_0, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo)) +
  geom_line(data = smart_0, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo))
graph1

graph2 <- ggplot() +
  ggtitle("Metodo 2") +
  geom_line(data = naive_1, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo)) +
  geom_line(data = smart_1, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo))
graph2

graph3 <- ggplot() +
  ggtitle("Metodo 3") +
  geom_line(data = naive_2, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo)) +
  geom_line(data = smart_2, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo))
graph3

graph4 <- ggplot() +
  ggtitle("Metodo 4") +
  geom_line(data = naive_3, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo)) +
  geom_line(data = smart_3, aes(x = lunghezza_log, y = tempo_log, colour = Algoritmo))
graph4
